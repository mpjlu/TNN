...
export TENSORRT_ROOT_DIR=/data/software/TensorRT-8.4.0.6
if [ -z $1 ];then export LIBTORCH_ROOT_DIR=/root/anaconda3/envs/torch1.9/lib/python3.8/site-packages/torch
else
